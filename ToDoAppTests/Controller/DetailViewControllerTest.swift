...
final class DetailViewControllerTest: XCTestCase {
    ...
    //при установке задачи хотим чтоб наш titleLabel принимал какое то значение
    func setupTaskAndAppearanceTransition() {
        ...
        //  beginAppearanceTransition(true, animated: true) - Сообщает дочернему контроллеру, что его внешний вид вот-вот изменится. Значение true, если представление контроллера дочернего представления будет добавлено в иерархию представлений, и значение false, если оно удаляется.
        sut.beginAppearanceTransition(true, animated: true)
        //endAppearanceTransition - Сообщает дочернему контроллеру, что его внешний вид изменился.
