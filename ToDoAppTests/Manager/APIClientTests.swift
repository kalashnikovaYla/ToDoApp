...
class APIClientTests: XCTestCase {
    ...
    //тест который будет проверять, что когда допустим пользователь залогинится, у нас с вами обращение к серверу использует правильный хост
    // host - for example "swiftbook.ru"
    func userLogin() {
    ...
    // MARK: YOUR HOMEWORK HARDWORKER! -> CONTINUE ON APIClient.swift
